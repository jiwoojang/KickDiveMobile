    ...
    public class FighterCollider : MonoBehaviour {
        ...
        private void OnCollisionEnter2D(Collision2D collision) {
            ...
            if (collision.collider.gameObject.activeInHierarchy) {
                FighterCollider collidedFighterCollider = collision.collider.GetComponent<FighterCollider>();
                ...
                if (collidedFighterCollider != null) {
                    ...
                    Debug.Log(gameObject.name + " Colliding with non-FighterCollider called " + collision.gameObject.name);
                }
            }
        }
    }
